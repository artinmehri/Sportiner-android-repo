-- Restore the notification-preferences contract if production schema drift removed it.
...
comment on table public.notification_preferences is
  'Product-level notification controls. OS notification permission is separate.';
...
revoke all on function public.ensure_notification_preferences_row(uuid)
  from public, anon, authenticated;
grant execute on function public.ensure_notification_preferences_row(uuid)
  to service_role;
